...
# File name for the CSV file
        file_name = f"k_{total_clusters}_c_{total_clients}_h_{homo}_p_{points_in_client1}_a_{additional_points_per_cluster}_nooverlap_big_data.csv"
